...
public class Advisor extends Instructor {
	...
	public static boolean checkCompletedCreditsForGraduationProject(Student student, Course course) {
	...
	public static boolean checkCreditsForTechnicalElective(Student student, Course course) {
		int totalCredit = student.getCurrentTranscript().calculateCompletedCredit();
	...
	public static Course detectConflict(Student student, Course course) {
		for(int i = 0; i<9; i++){
			for(int j = 0; j<5; j++){
